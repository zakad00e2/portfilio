...
export const LanguageSwitcher = () => {
  ...
  return (
    <div
      className="inline-flex rounded-full border border-slate-light/10 bg-navy-light/80 p-1 text-xs font-semibold shadow-lg shadow-background/20 backdrop-blur"
      role="group"
      dir="ltr"
